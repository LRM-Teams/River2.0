...
export const DEFAULT_SERVERS: Record<string, ServerConfig> = {
	...
	yamlls: { command: "yaml-language-server", args: ["--stdio"], fileTypes: [".yaml", ".yml"], rootMarkers: [".git"] },
	terraformls: {
	...
	nil: { command: "nil", args: [], fileTypes: [".nix"], rootMarkers: ["flake.nix", "default.nix", "shell.nix"] },
	ols: { command: "ols", args: [], fileTypes: [".odin"], rootMarkers: ["ols.json", ".git"] },
	dartls: {
		command: "dart",
	...
	vimls: { command: "vim-language-server", args: ["--stdio"], fileTypes: [".vim", ".vimrc"], rootMarkers: [".git"] },
